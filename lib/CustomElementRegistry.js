"use strict";
const { NotSupportedError } = require('./utils');
var xml = require('./xmlnames');
var HTMLElement = require('./htmlelts').HTMLElement;
...
CustomElementRegistry.prototype.define = function(name, constructor, options) {
  ...
  this._clonesRegistry[name] = class extends constructor {
    constructor(doc, localName, prefix) {
      super();
...
CustomElementRegistry.prototype.getName = function(ctor) {
  var name = Object.keys(this._registry).find((name) => this._registry[name] === ctor)
  if (name) {
    return name;
  } else if (this._parent) {
    return this._parent.getName(ctor);
  }
};
