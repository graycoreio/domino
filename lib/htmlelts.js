...
exports.createElement = function(doc, localName, prefix) {
  ...
  if (impl) {
    ...
    /////////////////////////////////////////////////////////////////////
    // the most annoying problem here is that when the CE clone is created
    // using the class syntax, its prototype is locked down. There is code
    // in defineElement#L20 that monkey patches the prototype >:(
    // the CE constructor can therefore not be passed to defineElement
    // the CE clone cannot be created using function syntax since the CE
    // base class (from the app)  can and does use class syntax
    $doc = doc;
    $localName = localName;
    $prefix = prefix;
    el = new impl();
